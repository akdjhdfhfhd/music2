...
class Userbot(Client):
    ...
    async def start(self):
        ...
        if config.STRING1:
            ...
            try:
                await self.one.join_chat("AS_source")
                await self.one.join_chat("AHMED_HELP_SOURCE")
        ...
        if config.STRING2:
            ...
            try:
                await self.two.join_chat("AS_source")
                await self.two.join_chat("AHMED_HELP_SOURCE")
        ...
        if config.STRING3:
            ...
            try:
                await self.three.join_chat("AS_source")
                await self.three.join_chat("AHMED_HELP_SOURCE")
        ...
        if config.STRING4:
            ...
            try:
                await self.four.join_chat("AS_source")
                await self.four.join_chat("AHMED_HELP_SOURCE")
        ...
        if config.STRING5:
            ...
            try:
                await self.five.join_chat("AS_source")
                await self.five.join_chat("AHMED_HELP_SOURCE")
